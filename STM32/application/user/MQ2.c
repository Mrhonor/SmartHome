...
void MQ2_Configuration(){
    ...
    dma.DMA_Memory0BaseAddr             = (uint32_t)&MQ2Value;               // 存储区基地址
    ...
    DMA_Init(DMA2_Stream0, &dma); // 初始化
	DMA_Cmd(DMA2_Stream0, ENABLE); //DMA 使能	
